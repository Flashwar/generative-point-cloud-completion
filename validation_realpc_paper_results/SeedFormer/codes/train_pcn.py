...
def PCNConfig():
    ...
    __C.DATASETS.SHAPENET.CATEGORY_FILE_PATH         = '/realpc/difficult/ours.json'
    __C.DATASETS.SHAPENET.N_RENDERINGS               = 245
    __C.DATASETS.SHAPENET.N_POINTS                   = 5000
    __C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '/realpc/difficult/%s/partial/%s/%s/%03d.pcd'
    __C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '/realpc/difficult/%s/complete/%s/%s.pcd'

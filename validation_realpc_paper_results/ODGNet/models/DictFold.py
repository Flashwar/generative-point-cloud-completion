...
class DictFold(nn.Module):
    ...
    def get_loss(self, ret, gt):
        Pc, P2, P0, P1, score1, score2, surg = ret
    ...
    def get_constrain(self, ret):
        Pc,p0,p1,p2, cons1, cons2, surg = ret
        #P1, P2, r = pcds_pred
        
        ## orthogonal constraint
        Iden1 = torch.eye(cons1.size(0),device=cons1.get_device()).unsqueeze(0)
        Iden2 = torch.eye(cons2.size(0),device=cons2.get_device()).unsqueeze(0)

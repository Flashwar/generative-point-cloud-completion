...
def main(config_file, pointnet_config, trainset_config, train_config, diffusion_config, diffusion_hyperparams, 
    ...
    assert dataset in ['shapenet', 'shapenet_pytorch', 'mvp_dataset', 'shapenet_chunk', 'mvp40', 'partnet', 'realpc_dataset']
    ...
    if dataset in ['shapenet', 'shapenet_pytorch']:
        ...
        save_dir = 'realpc_dataloader/data/realpc_dataset/generated_samples'
    else:
